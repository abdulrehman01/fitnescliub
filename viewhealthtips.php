...
<?php
	$con=new PDO("mysql:host=localhost;dbname=login","root","");
		...
		$select=$con->query("SELECT * From healthtips");
		$r=0;		
?>
<html lang="en">
  <head>
	...
	<body style="background-image:url(images/banner4.jpg)">
							...
							<tr>
									<th style="border:1px solid white;font-style:bold;font-size: 20px;color:white"> Tip no. </th>
									<th style="border:1px solid white;font-style:bold;font-size: 20px;color:white"> HealthTips </th>
