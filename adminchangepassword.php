           ...
           <br><br><br><br><br>
    			   <div class="col-sm-1 middle-border"></div>
                        <div class="col-sm-3"></div>
							<div  class="col-sm-4">
                        	  <form style="color:white" role="form" action="adminchangepassword.php" method="post" class="registration-form">
...
try
{
	...
	else
	{
			...
			$select=$con->prepare("SELECT * From admin WHERE pass='$oldpass' AND fName='$fname'");
			...
			if($data['pass']==$oldpass)
			{
				...
				$select=$con->prepare("update admin set pass='$newpass' where pass='$oldpass'AND fName='$fname'");
				$select->setFetchMode(PDO::FETCH_ASSOC);
				$select->execute();
