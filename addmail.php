           ...
           <br><br><br><br><br>
    			   <div class="col-sm-1 middle-border"></div>
                        <div class="col-sm-3"></div>
							<div  class="col-sm-4">
                        	  <form style="color:white" role="form" action="addmail.php" method="post" class="registration-form">
                        	      <div  class="form-group" >
									...
									<label style="font-style:bold;font-size: 20px">Add new mail</label>
                        	        <textarea name="mail" 
				                        				class="form-about-yourself form-control"></textarea>
                      	        </div>
								  <input type ="submit" style="color:black;width:200px" name="submit"  value="Add mail" class="form-signup form-control" id="form-signup">
                      	   
							  </form>
							  <br>
							  <form role="form" action="user_services.php" method="post" class="registration-form">
...
$con=new PDO("mysql:host=localhost;dbname=login","root","");
	...
	if($mail=='')
	{
		echo"<script>alert('please enter mail')</script>";
		exit();
	}
	else
	{
		$select=$con->prepare("insert into mails(uFName,uLName,mail) value('$fName','$lName','$mail')");
