...
<?php
	$con=new PDO("mysql:host=localhost;dbname=login","root","");
		...
		$select=$con->query("SELECT * From excercisevideos");
		$r="0";
?>
<html lang="en">
  <head>
	...
	<body style="background-image:url(images/banner4.jpg)">
							...
							<table style="border:1px solid white;font-style:bold;font-size: 20px;color:white">
								<tr style="border:1px solid white">
									...
									<th style="border:1px solid white;font-style:bold;font-size: 20px;color:white"> Video links </th>
								...
								$r++;
								echo"<td>".$r."</td>";
								echo "<td> <a href=".$row['videos']." style='color:white'>".$row['videos']."</a></td>";
